// client/vite-project/src/components/GameResultPage.jsx
...
const GameResultPage = ({
  ...
  const getResultDetails = () => {
    ...
    switch (outcome) {
      ...
      case 'draw_fivefold_repetition':
        return (
          <div className="result-details">
            <p>Result: <span className="draw-reason">Draw</span></p>
            <p className="game-end-message">
  ...
  return (
    <div className="game-result-page">
      <div className={`game-result-container ${getResultClass()}`}>
        <h1>Game Over</h1>
